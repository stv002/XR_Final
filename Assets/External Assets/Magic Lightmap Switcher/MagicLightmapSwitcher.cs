    ...
    public class MagicLightmapSwitcher : MonoBehaviour
    {
        ...
        public class AffectedObject
        {
            ...
            public void SetShaderFloat(string property, float value)
            {
                ...
                //             {
                //                 if (meshRenderer.sharedMaterials[i].name.StartsWith("Outline", System.StringComparison.Ordinal))
                //                 {
                //                     continue;
                //                 }
                //
                //                 meshRenderer.sharedMaterials[i].SetFloat(property, value);
                //             }
                //         }
                //         else
                //         {
        ...
        private void StoreAffectableObjects(string targetScene)
        {
            ...
            foreach (MeshRenderer meshRenderer in renderers)
            {
                ...
                if (staticRenderer != null)
                {
                    ...
                    affectableObject.mlsObject = meshRenderer.GetComponent<MLSObject>();
