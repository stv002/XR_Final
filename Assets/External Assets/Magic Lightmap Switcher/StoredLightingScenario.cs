    ...
    public class StoredLightingScenario : ScriptableObject
    {
...
#endif
#if MT_HDRP_9_INCLUDED || MT_HDRP_10_INCLUDED || MT_HDRP_11_INCLUDED || MT_HDRP_12_INCLUDED || MT_HDRP_13_INCLUDED || MT_HDRP_14_INCLUDED
...
#endif
#if MT_HDRP_9_INCLUDED || MT_HDRP_10_INCLUDED || MT_HDRP_10_INCLUDED || MT_HDRP_11_INCLUDED || MT_HDRP_12_INCLUDED || MT_HDRP_13_INCLUDED || MT_HDRP_14_INCLUDED
                    if (hdriSky != null)
                    {
        ...
        public void RebuildSourceList()
        {
            if (cyclic)
            {
                ...
                for (int i = blendableLightmaps.Count - 1; i > 0; i--)
                {
                    LightmapData cyclicLightmap =
                        new LightmapData(blendableLightmaps[i - 1].blendingIndex,
                            blendableLightmaps[i - 1].prevBlendingIndex,
                            blendableLightmaps[i - 1].startValue,
                            blendableLightmaps[i - 1].reflectionsBlendingRange,
                            blendableLightmaps[i - 1].lightmapBlendingRange,
                            blendableLightmaps[i - 1].lightingData);

                    blendableLightmaps.Add(cyclicLightmap);
                }
            }
            else
            {
