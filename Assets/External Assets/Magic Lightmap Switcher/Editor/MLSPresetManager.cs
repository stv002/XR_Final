...
namespace MagicLightmapSwitcher
{
    ...
    public class MLSPresetManager : EditorWindow
    {
        ...
        private static Vector2 _generalScrollPos;
        private static Vector2 _objectsScrollPos;
        private static Vector2 _lightsScrollPos;
        private static Vector2 _bakeryLightMeshesScrollPos;
        private static Vector2 _customBlendablesScrollPos;
        ...
        public static void CreateNewPreset(MagicLightmapSwitcher magicLightmapSwitcher, MagicLightmapSwitcher.SceneLightingPreset copyFrom = null)
        {
            MagicLightmapSwitcher.SceneLightingPreset lightingPreset = new MagicLightmapSwitcher.SceneLightingPreset
                {
                    name = "New Preset" + "_" + magicLightmapSwitcher.lightingPresets.Count.ToString()
                };
            ...
            if (magicLightmapSwitcher.lightingPresets.Count > 0)
            {
                if (copyFrom != null)
                {
                    lightingPreset.lightSourceSettings = copyFrom.lightSourceSettings.Select(element => new MagicLightmapSwitcher.SceneLightingPreset.LightSourceSettings() 
                    {
                        ...
                        shadowStrength = element.shadowStrength,
...
#if BAKERY_INCLUDED
                    lightingPreset.bakeryLightMeshesSettings = 
                        copyFrom.bakeryLightMeshesSettings.Select
                        (element => new MagicLightmapSwitcher.SceneLightingPreset.LightSourceSettings.BakeryLightMeshesSettings()
                    {
                    ...
                    lightingPreset.skyboxSettings.bakerySkyLightsSettings = 
                        new MagicLightmapSwitcher.SceneLightingPreset.SkyboxSettings.BakerySkyLightsSettings
                        (copyFrom.skyboxSettings.bakerySkyLightsSettings);
#endif
                }
                else
                {
            ...
            else
            {
                ...
                if (RenderSettings.skybox != null)
                {
                    ...
                    {
                        lightingPreset.skyboxSettings.exposure =
                ...
                for (int lp = 0; lp < magicLightmapSwitcher.lightingPresets.Count; lp++)
                {
                    using (new GUILayout.VerticalScope(GUI.skin.box))
                    {
                        ...
                        if (magicLightmapSwitcher.lightingPresets[lp].foldoutEnabled)
                        {
                            ...
                            if (magicLightmapSwitcher.lightingPresets[lp].gameObjectsSettings.Count > 10)
                            {
                                _objectsScrollPos = EditorGUILayout.BeginScrollView(_objectsScrollPos,
                                    magicLightmapSwitcher.lightingPresets[lp].gameObjectsSettings.Count > 10
                            ...
                            using (new GUILayout.VerticalScope(GUI.skin.box))
                            {
                                ...
                                {
                                    if (magicLightmapSwitcher.lightingPresets[lp].gameObjectsSettings[i].gameObject == null)
                                    {
                                        magicLightmapSwitcher.lightingPresets[lp].gameObjectsSettings.RemoveAt(i);
                                    }
                            ...
                            if (magicLightmapSwitcher.lightingPresets[lp].lightSourceSettings.Count > 10)
                            {
                                _lightsScrollPos = EditorGUILayout.BeginScrollView(_lightsScrollPos,
                                    magicLightmapSwitcher.lightingPresets[lp].lightSourceSettings.Count > 10
                                        ? GUILayout.MaxHeight(200)
                                        : GUILayout.MaxHeight(0),
                                    magicLightmapSwitcher.lightingPresets[lp].lightSourceSettings.Count > 10
                                        ? GUILayout.MinHeight(200)
                            ...
                            using (new GUILayout.VerticalScope(GUI.skin.box))
                            {
                                ...
                                for (int i = 0; i < magicLightmapSwitcher.lightingPresets[lp].lightSourceSettings.Count; i++)
                                {
                                    using (new GUILayout.VerticalScope(GUI.skin.box))
                                    {
                                        ...
                                        magicLightmapSwitcher.lightingPresets[lp].lightSourceSettings[i].light.GetComponent<MLSLight>().lastEditedBy = 
                                            magicLightmapSwitcher.lightingPresets[lp].name;
...
#if MT_HDRP_10_INCLUDED || MT_HDRP_11_INCLUDED || MT_HDRP_12_INCLUDED || MT_HDRP_13_INCLUDED || MT_HDRP_14_INCLUDED
...
#endif
                                                            break;
#if !MT_HDRP_7_INCLUDED && !MT_HDRP_8_INCLUDED && !MT_HDRP_9_INCLUDED && !MT_HDRP_10_INCLUDED && !MT_HDRP_11_INCLUDED
#if MT_HDRP_12_INCLUDED || MT_HDRP_13_INCLUDED || MT_HDRP_14_INCLUDED
                            ...
                            if (magicLightmapSwitcher.lightingPresets[lp].bakeryLightMeshesSettings.Count > 10)
                            {
                                _bakeryLightMeshesScrollPos = EditorGUILayout.BeginScrollView(
                                    _bakeryLightMeshesScrollPos,
                                    magicLightmapSwitcher.lightingPresets[lp].bakeryLightMeshesSettings.Count > 10
                                        ? GUILayout.MaxHeight(200)
                                        : GUILayout.MaxHeight(0),
                                    magicLightmapSwitcher.lightingPresets[lp].bakeryLightMeshesSettings.Count > 10
                                        ? GUILayout.MinHeight(200)
                            ...
                            if (magicLightmapSwitcher.lightingPresets[lp].customBlendablesSettings.Count > 10)
                            {
                                _customBlendablesScrollPos = EditorGUILayout.BeginScrollView(_customBlendablesScrollPos,
                                    magicLightmapSwitcher.lightingPresets[lp].customBlendablesSettings.Count > 10
                                        ? GUILayout.MaxHeight(200)
                                        : GUILayout.MaxHeight(0),
                                    magicLightmapSwitcher.lightingPresets[lp].customBlendablesSettings.Count > 10
                                        ? GUILayout.MinHeight(200)
                            ...
                            using (new GUILayout.VerticalScope(GUI.skin.box))
                            {
                                ...
                                if (magicLightmapSwitcher.lightingPresets[lp].skyboxSettings.globalFoldoutEnabled)
                                {
                                    using (new GUILayout.VerticalScope(GUI.skin.box))
                                    {
                                        ...
                                        string[] directContributionOptions = new string[] 
                                        ...
                                        if (magicLightmapSwitcher.lightingPresets[lp].skyboxSettings.bakerySkyLightsSettings != null)
                                        {
                                            ...
                                            if (magicLightmapSwitcher.lightingPresets[lp].skyboxSettings.bakerySkyLightsSettings.bakerySkylightFoldoutEnabled)
                                            {
                                                ...
                                                ////magicLightmapSwitcher.lightingPresets[lp].skyboxSettings.skyboxTexture =
                                                ////    magicLightmapSwitcher.lightingPresets[lp].skyboxSettings
                                                ////        .bakerySkyLightsSettings.cubemap;
                                                ...
                                                magicLightmapSwitcher.lightingPresets[lp].skyboxSettings.bakerySkyLightsSettings.contrib = 
                                                    (ftDirectLightInspector.BakeWhat)EditorGUILayout.Popup("Baked contribution", 
                                                        (int)magicLightmapSwitcher.lightingPresets[lp].skyboxSettings.bakerySkyLightsSettings.contrib, directContributionOptions);

                                                if (magicLightmapSwitcher.lightingPresets[lp].skyboxSettings
                                                        .bakerySkyLightsSettings.contrib == ftDirectLightInspector.BakeWhat.IndirectOnly)
                                                {
                                                    magicLightmapSwitcher.lightingPresets[lp].skyboxSettings
                                                        .bakerySkyLightsSettings.bakeToIndirect = false;
                                                }
                                                else
                                                {
                                                    magicLightmapSwitcher.lightingPresets[lp].skyboxSettings
                                                        .bakerySkyLightsSettings.bakeToIndirect = true;
                                                }
